...
class _drowerState extends State<drower> {
  ...
  Widget build(BuildContext context) {
    ...
    child: ClipRRect(
    borderRadius: BorderRadius.circular(50),
    child: Image.asset('assets/img/WhatsApp Image 2024-02-26 at 9.35.39 PM.jpeg')),
    ),
    ),
    ...
    child: Row(
    children: [
    Text('DK Patel',style: TextStyle(fontSize: 20,fontWeight: FontWeight.normal,),),
    ],
    ),
    ),
    Padding(
    ...
    child: Row(
    children: [
    Text('dkpatel3@gmail.com',style: TextStyle(fontSize: 13,fontWeight: FontWeight.normal,),),
    ],
    ),
    ),
